...
CC_FLAGS=-std=c++1y -O3 -pipe -ffast-math -mfpmath=sse -flto -fno-omit-frame-pointer -march=native -mtune=native -I/Users/19nbourgeois_68/homebrew/include
else
FLAGS=-lGL -lpthread -lsfml-system -lsfml-window -lsfml-graphics -lGLEW
CC_FLAGS=-std=c++1y -O3 -pipe -ffast-math -mfpmath=sse -flto -fno-omit-frame-pointer -march=native -mtune=native
endif
